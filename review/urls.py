...
urlpatterns = [
    ...
    path('password_reset_confirm/<uidb64>/<token>',auth_views.PasswordResetView.as_view(template_name='users/password_reset_confirm.html'),name='password_reset_confirm'),
